...
export default function PrivacyPolicy() {
  ...
  return (
    <>
      <Head>
        <title>Privacy Policy | The Nexus Airdrop</title>
        <meta name="description" content="Privacy Policy for The Nexus Airdrop - Learn how we collect, use, and protect your personal information." />
      </Head>
              ...
              <div className="glass-card p-4 p-md-5">
                ...
                <div className="policy-section">
                  ...
                  <p className="text-sm opacity-80 mb-3 font-body">
                    At The Nexus Airdrop, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our decentralized exchange platform and related services.
                  </p>
