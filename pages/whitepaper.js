...
export default function Whitepaper() {
  ...
  return (
    <>
      <Head>
        <title>Whitepaper | The Nexus Airdrop</title>
        <meta name="description" content="The Nexus Airdrop Whitepaper - A comprehensive overview of our decentralized exchange platform, tokenomics, and technical architecture." />
      </Head>
              ...
              <div className="glass-card p-4 p-md-5">
                ...
                <div className="whitepaper-section">
                  ...
                  <p className="text-sm opacity-80 mb-3 font-body">
                    The Nexus Airdrop is a revolutionary decentralized exchange platform that combines advanced trading features with robust security measures. Our platform aims to provide users with a seamless, secure, and efficient trading experience while maintaining full decentralization and transparency.
                  </p>
                </div>
